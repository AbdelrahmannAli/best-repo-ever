	...
	(function (w, F) {
		...
		function ob(a, b, c, d, f) {
			switch (b) {
				...
				case "html":
					return (
						0 === f.insertionMode && a.push("<!DOCTYPE html>"),
						aa(a, c, b, d)
					);
				default:
					...
					switch (c.$$typeof) {
						...
						case Ga:
							...
							a.context._currentValue2 =
								d === Gb ? a.context._defaultValue : d;
							a = D = a.parent;
							b.context = a;
							return;
						case Fa:
									...
									null === k
										...
										: (k.pendingTasks--,
										  k.forceClientRender ||
												...
												(k.errorDigest = q),
												k.parentFlushed &&
													h.clientRenderedBoundaries.push(
														k
													)));
									h.allPendingTasks--;
